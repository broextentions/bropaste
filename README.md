<div align="center">
  ...
  <p>
    ...
    <a href="#-bropaste-ru">Русская версия 🇷🇺</a>
  </p>
...
1. Click the extension icon to add new text snippets.
2. **Right-click** on any input field on a website.
3. Hover over the **BroPaste** menu item and select your text.
4. Done!
...
- **🔒 100% Приватность** Все данные хранятся локально на вашем устройстве. Никаких облаков и отслеживания.
...
1. Склонируйте или скачайте этот репозиторий (ZIP-архив).
...
<div align="center">
  <sub>Built with <a href="https://github.com/broextentions" target="_blank" class="footer-info" title="https://github.com/broextentions">
        <img src="vendor/logo/logo.png" alt="Logo">
        <span class="footer-text">BroExtentions</span>
    </a><img src="vendor/logo/logo.png" alt="Logo"></sub>
</div>
